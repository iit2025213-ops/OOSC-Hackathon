    ...
    <div className="min-h-screen flex items-center justify-center px-4 relative">
      ...
      <div className="max-w-md w-full glass-panel rounded-2xl p-8 shadow-[0_20px_50px_rgba(0,0,0,0.3)] border border-white/10">
        <div className="text-center mb-8">
          ...
          <h2 className="font-display-lg text-display-md text-on-surface">Create Account</h2>
          <p className="font-body-md text-on-surface-variant mt-2">Join us to start solving cases.</p>
        </div>
